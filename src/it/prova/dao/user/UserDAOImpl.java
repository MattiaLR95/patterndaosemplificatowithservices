...
public class UserDAOImpl extends AbstractMySQLDAO implements UserDAO {
	...
	public List<User> findAllLoginStartsWith(String iniziale) throws Exception {
		...
		if (isNotActive())
			throw new Exception("Connessione non attiva. Impossibile effettuare operazioni DAO.");
		if (iniziale.equals(null))
			throw new Exception("Attenzione! Variabile inserita non valida");
	...
	public List<User> findAllCreatedBefore(Date dataConfronto) throws Exception {
		...
		if (dataConfronto == null)
			throw new Exception("Attenzione! Parametro inserito non valido");
	...
	public List<User> searchForSurnameAndNameThatStartWith(String cognomeInput, String inzialeNomeInput) throws Exception {
		...
		if(isNotActive())
			throw new Exception("Connessione non attiva. Impossibile effettuare operazioni DAO.");
		if(cognomeInput.equals(null) || inzialeNomeInput.equals(null))
			throw new Exception("Attenzione! parametri inseriti non validi");
	...
	public User signIn(String loginInput, String passwordInput) throws Exception {
		if(isNotActive())
			throw new Exception("Connessione non attiva. Impossibile effettuare operazioni DAO.");
		if(loginInput.equals(null) || passwordInput.equals(null))
			throw new Exception("Attenzione! I parametri inseriti non sono validi");
